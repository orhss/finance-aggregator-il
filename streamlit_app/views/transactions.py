...
from streamlit_app.utils.session import get_tag_service, get_all_categories, get_all_tags, format_amount_private
...
def render_desktop_transactions():
    """Render full desktop transactions view."""
        ...
        if search_query:
            if total_transactions > 0:
                ...
                **Try:**
                ...
                - Searching by amount (e.g., "100" for transactions around that amount)
        ...
        if not transactions:
            ...
            for idx, txn in enumerate(transactions, start=1):
                ...
                row_data = {
                    ...
                    'Tags': tags_str,
                    'Status': 'Completed' if txn.status == 'completed' else 'Pending',
            ...
            def format_amount_display(val):
                ...
                charged_currency = val.get('charged_currency', 'ILS')
            ...
            # ============================================================================
            st.markdown('<div class="section-title">Edit Transaction</div>', unsafe_allow_html=True)
            ...
            if selected_txn_id:
                ...
                if txn:
                    ...
                    with col2:
                        st.markdown('<div class="edit-section-header">Editable Fields</div>', unsafe_allow_html=True)
